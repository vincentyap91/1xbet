...
(function () {
      ...
      games: [
        {
          id: "cs2",
          name: "CS 2",
          icon: "assets/icons/esports/icon-cs2.svg",
          leagues: [
            {
              id: "cs2-berserk",
        ...
        },
        {
          ...
          icon: "assets/icons/esports/icon-lol.svg",
          leagues: [
            {
              id: "lol-china",
        ...
        },
        {
          id: "hok",
          name: "Honor of Kings",
          icon: "assets/icons/esports/icon-hok.svg",
          leagues: [
            {
              id: "hok-cup",
        ...
        },
        {
          id: "mlbb",
          name: "Mobile Legends",
          icon: "assets/icons/esports/icon-mlbb.svg",
          leagues: [
            {
              id: "mlbb-sea",
  ...
  function matchToFavouriteRecord(m, sportId) {
    ...
    return {
      ...
      league: m.league || "",
      home: m.home || "",
      homeLogo: m.homeLogo || "assets/images/mobile-home/teams/team-01.webp",
      away: m.away || "",
      awayLogo: m.awayLogo || "assets/images/mobile-home/teams/team-02.webp",
